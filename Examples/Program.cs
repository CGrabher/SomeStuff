...

{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Collatz_Conjecture cc = new Collatz_Conjecture();

            Collatz_Conjecture_Recursive ccr = new Collatz_Conjecture_Recursive();

            int n = 777;

            Console.WriteLine("The Collatz sequence for the number {0} is:", n);
            Console.WriteLine(string.Join(" | ", cc.CollatzSequence(n)));
            Console.WriteLine("\nThe recursive Collatz sequence for the number {0} is:", n);
            Console.WriteLine(string.Join(" | ", ccr.CollatzSequenceRecursive(n)));
